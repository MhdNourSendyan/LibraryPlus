...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $pdo->query("UPDATE users SET accountActivated = 1 WHERE userID = ?");
        ...
        if ($pdo->execute()) {
            ...
            $response = [
                ...
                "text" => $_SESSION["lang"]["UsersControl.php"]["ThrowModal"]["AccountActivated"],
        ...
        $response = [
            ...
            "alertType" => "danger",
            "confirmMessage" => $_SESSION["lang"]["UsersControl.php"]["ThrowModal"]["Confirm"],
            "text" => $_SESSION["lang"]["UsersControl.php"]["ThrowModal"]["AccountNotActivated"],
            "buttonText" => $_SESSION["lang"]["UsersControl.php"]["Buttons"]["Close"],
